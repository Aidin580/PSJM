    ...
    <div className={style.container}>
      <div className={style.header}>
        <div className={style.right}>
          ...
          <p>{!loading && `${filteredAndSortedStudents.length} دانش آموز حاضر هستند`}</p> {/* منطقش عوض نشده فقط کلمرو عوض کردم */}
          <p>{!loading && `${filteredAndSortedStudents.length} دانش آموز غایب هستند`}</p> {/* منطقش عوض نشده فقط کلمرو عوض کردم */}
        </div>
