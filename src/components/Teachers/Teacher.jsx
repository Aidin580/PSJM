        ...
        <div className={style.container}>
            <div className={style.header}>
                <div className={style.right}>
                    ...
                    <p>{absentCount > 0 ? `${absentCount.length} نفر حاضر هستند.` : ''}</p> {/* منطقش عوض نشده فقط کلمرو عوض کردم */}
                    <p>{absentCount > 0 ? `${absentCount.length} نفر غایب هستند.` : 'غایب وجود ندارد.'}</p> {/* منطقش عوض نشده فقط کلمرو عوض کردم */}
                </div>
