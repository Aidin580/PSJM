                            ...
                            <div className={style.table}>
                                {visibleSchools.map((s) => (
                                    <div className={style.row} key={s.id}>
                                        ...
                                        <div className={style.item}><p>{s.province}</p></div>
                                        <div className={style.item}><p>{s.city}</p></div>
                                        <div className={style.item}><p>{s.status}</p></div>
                                        <div className={style.item}><p>{s.code}</p></div>
                                        <div className={style.item}><p>{s.present}</p></div>
                                        <div className={style.item}><p>{s.absent}</p></div>
                                        <div className={style.item}><p>{s.adminName}</p></div>

                                        <div className={`${style.edit} ${style.display}`} onClick={() => handleEditClick(s.id)}>
                                            <p>مدیریت</p>
                                        </div>
                                    </div>
                                ))}
