...
const SettingsPanel = ({ onClose }) => {
    ...
    return (
        <div className={styles.settingsPanel}>
            ...
            <div className={styles.settingsPaneloption} ><img alt='' src={bold} /><p>برجسته سازی متون</p></div>
            <div className={styles.settingsPaneloption} ><img alt='' src={dark} /><p>فعالسازی حالت تاریک</p></div>
